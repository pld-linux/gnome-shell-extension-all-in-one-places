...
install *.js* $RPM_BUILD_ROOT%{_datadir}/gnome-shell/extensions/all-in-one-places@jofer
install *.css $RPM_BUILD_ROOT%{_datadir}/gnome-shell/extensions/all-in-one-places@jofer
